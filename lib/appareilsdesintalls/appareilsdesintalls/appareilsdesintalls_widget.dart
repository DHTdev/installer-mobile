...
class AppareilsdesintallsWidget extends StatefulWidget {
  ...
  @override
  State<AppareilsdesintallsWidget> createState() =>
      _AppareilsdesintallsWidgetState();
}
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    ].divide(SizedBox(width: 15)).around(SizedBox(width: 15)),
                  ),
                ],
              ),
              SafeArea(
                          ...
                          children: [
                            Center(
                              child: InkWell(
                                ...
                                // onTap: () async {
                                //   _model.apiResult8o1 =
                                //       await TechnicienGroup.tasksCall.call();
                                //   safeSetState(() {});
                                // },
                                child: wrapWithModel(
                                  model: _model.returnedDevicesModel,
                                  updateCallback: () => safeSetState(() {}),
                                  child: const ReturnedDevicesWidget(),
                                ),
                              ),
                            ),
                          ],
