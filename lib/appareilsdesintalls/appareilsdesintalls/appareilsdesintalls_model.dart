...
class AppareilsdesintallsModel extends FlutterFlowModel<AppareilsdesintallsWidget> {
  ///  Local state fields for this page.

  bool isShowFullList = true;

  List<ReturnedDevicesStruct> returnedDevices = [];
  void addToReturnedDevices(ReturnedDevicesStruct item) => returnedDevices.add(item);
  void removeFromReturnedDevices(ReturnedDevicesStruct item) => returnedDevices.remove(item);
  void removeAtIndexFromReturnedDevices(int index) => returnedDevices.removeAt(index);
  void insertAtIndexInReturnedDevices(int index, ReturnedDevicesStruct item) => returnedDevices.insert(index, item);
  void updateReturnedDevicesAtIndex(int index, Function(ReturnedDevicesStruct) updateFn) => returnedDevices[index] = updateFn(returnedDevices[index]);
  ...
  void insertAtIndexInSelectedDevices(int index, int item) => selectedDevices.insert(index, item);
  void updateSelectedDevicesAtIndex(int index, Function(int) updateFn) => selectedDevices[index] = updateFn(selectedDevices[index]);
  ...
  void initState(BuildContext context) {
    returnedDevicesModels = FlutterFlowDynamicModels(() => ReturnedDevicesModel());
