...
import 'commercial_model.dart';
export 'commercial_model.dart';

class CommercialWidget extends StatefulWidget {
  const CommercialWidget({super.key});

  static String routeName = 'Commercial';
  static String routePath = '/commercial';
...
class _CommercialWidgetState extends State<CommercialWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommercialModel());
