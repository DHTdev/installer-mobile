...
class NotifsWidget extends StatefulWidget {
  ...
  final DateTime? date;
  final int? id;
  final DateTime? datePD;
  final DateTime? dateAF;
  final int? etatTache;
          ...
          await showModalBottomSheet(
            ...
            builder: (context) {
              return Padding(
                ...
                child: DetailsWidget(
                  detailsTask: TechnicianTaskStruct(
                    id: widget.id,
                    date_previsionnelle_debut: widget.datePD,
                    date_affectation: widget.dateAF,
                    uti_utilsateur_id: widget.uuID,
                    observation: widget.observation,
                    matricule: widget.matricule,
                    IMEI: widget.imei,
                    proprietaire: widget.propietaire,
                    SIM: widget.sim,
                    SIM_proprietaire: widget.simPropietaire,
                    clientName: widget.clientName,
                    cityName: widget.cityName,
                    catache: widget.catache,
                    gps_principale: widget.gpsPrincipal,
                    etatTache: widget.etatTache,
                    clientPhoneNumber: widget.telClient,
