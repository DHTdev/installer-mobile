...
/// Create a component within i should be able to multi filter through two
/// dropdowns, text fields and  other values
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  _model.apiResultCities =
                                      await GetAllCitiesCall.call();

                                  if ((_model.apiResultCities?.succeeded ??
                                      true)) {
                                    _model.cities = (getJsonField(
                                      (_model.apiResultCities?.jsonBody ?? ''),
                                      r'''$.Cities''',
                                      true,
                                    )!
                                            .toList()
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller:
                                    _model.dateDropDpownValueController ??=
                                        FormFieldController<String>(null),
                                options: ['Aujourd\'hui', 'Demain', 'Hier'],
                                onChanged: (val) async {
                                  safeSetState(
                                      () => _model.dateDropDpownValue = val);
                                  _model.selectedDateFilter =
                                      _model.dateDropDpownValue;
                                  safeSetState(() {});
                                },
                                width: 200.0,
                                height: 40.0,
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  controller:
                                      _model.taskTypeDropDownValueController ??=
                                          FormFieldController<String>(null),
                                  options: [
                                    'installation',
                                    'desinstalation',
