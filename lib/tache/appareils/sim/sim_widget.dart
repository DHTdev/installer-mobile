...
class SimWidget extends StatefulWidget {
  ...
  static String routeName = 'SIM';
  static String routePath = '/sim';
...
class _SimWidgetState extends State<SimWidget> {
  late SimModel _model;

  late List<SimStruct> simStruct;
  ...
  void initState() {
    super.initState();
    simStruct = FFAppState().devicesSim;
    _model = createModel(context, () => SimModel());
