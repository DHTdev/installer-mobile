...
import 'taches_reporte_model.dart';
export 'taches_reporte_model.dart';

class TachesReporteWidget extends StatefulWidget {
  const TachesReporteWidget({
    super.key,
    required this.id,
  ...
  @override
  State<TachesReporteWidget> createState() => _TchesreporteWidgetState();
}

class _TchesreporteWidgetState extends State<TachesReporteWidget> {
                                        ...
                                        children: [
                                          Expanded(
                                            child: Container(
                                              width: 200,
                                              child: TextFormField(
                                                controller: _model.dateSitterTextController,
                                                focusNode: _model.dateSitterFocusNode,
                                                autofocus: false,
                                                enabled: true,
                                                readOnly: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText: dateTimeFormat("yyyy-MM-dd HH:mm:ss", _model.sectedDateFromBtn),
                                                ...
                                                validator: _model.dateSitterTextControllerValidator.asValidator(context),
                                              ),
                                            ),
                                          ),
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              safeSetState(() {
                                                _model.dateSitterTextController?.text = dateTimeFormat("yyyy-MM-dd HH:mm:ss", _model.sectedDateFromBtn);
                                              });
                                            },
                                          ),
                                        ],
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        maxLines: 4,
                                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                                        validator: _model.observationTextControllerValidator.asValidator(context),
                                      ),
                                    ),
                                  ),
                                ),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.actionTP = await TechnicienGroup.postponeTaskCall.call(
                                    id: widget.id,
                                    NouvelleDate: _model.sectedDateFromBtn?.toString(),
                                  ...
                                  if ((_model.actionTP?.succeeded ?? true)) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Le report de la t̢che a ̩t̩ effectu̩',
                                          style: TextStyle(
                                            color: FlutterFlowTheme.of(context).primaryText,
                                          ),
                                        ),
