...
class PanneGpsSubmitStruct extends BaseStruct {
  ...
  static PanneGpsSubmitStruct fromMap(Map<String, dynamic> data) =>
      PanneGpsSubmitStruct(
  ...
  static PanneGpsSubmitStruct? maybeFromMap(dynamic data) => data is Map
      ? PanneGpsSubmitStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PanneGpsSubmitStruct fromSerializableMap(Map<String, dynamic> data) =>
      PanneGpsSubmitStruct(
