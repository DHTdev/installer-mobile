...
class PanneSimSubmitStruct extends BaseStruct {
  ...
  static PanneSimSubmitStruct fromMap(Map<String, dynamic> data) =>
      PanneSimSubmitStruct(
  ...
  static PanneSimSubmitStruct? maybeFromMap(dynamic data) => data is Map
      ? PanneSimSubmitStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PanneSimSubmitStruct fromSerializableMap(Map<String, dynamic> data) =>
      PanneSimSubmitStruct(
  ...
  int get hashCode => const ListEquality()
      .hash([imei, observation, ancienSIM, nouveauSim, matricule, images]);
}
