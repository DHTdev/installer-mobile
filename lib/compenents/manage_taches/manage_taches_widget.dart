            ...
            InkWell(
              ...
              onTap: () async {
                if ((widget.taskType == 'installation gasoil') ||
                  ...
                  if (widget.taskType == 'Changement du GPS') {
                    context.pushNamed(
                    ...
                    if (widget.taskType == 'reparationRelais') {
                      context.pushNamed(
                      ...
                      if (widget.taskType == 'Reinstallation') {
                        context.pushNamed(ReinstallationWidget.routeName);
                      } else {
                        if (widget.taskType == 'Changement du SIM') {
                          context.pushNamed(
                            PanneSIMWidget.routeName,
                            queryParameters: {
                              'clientName': serializeParam(
                                '',
                                ParamType.String,
                          ...
                          if (widget.taskType == 'Panne') {
                            context.pushNamed(
                              PanneWidget.routeName,
                              queryParameters: {
                                'clientName': serializeParam(
                                  '',
                                  ParamType.String,
                            ...
                            context.pushNamed(DesinstallationWidget.routeName);
                          }
                        }
                      }
                    }
