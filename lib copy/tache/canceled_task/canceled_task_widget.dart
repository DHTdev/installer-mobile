...
export 'canceled_task_model.dart';

class CanceledTaskWidget extends StatefulWidget {
  const CanceledTaskWidget({
    super.key,
    this.infoTask,
  });
  ...
  static String routeName = 'CanceledTask';
  static String routePath = '/canceledTask';

  @override
  State<CanceledTaskWidget> createState() => _CanceledTaskWidgetState();
}

class _CanceledTaskWidgetState extends State<CanceledTaskWidget> {
  late CanceledTaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CanceledTaskModel());
                        ...
                        children: [
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: widget.infoTask!.clientName,
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.apiResult4wc = await TechnicienGroup.cancelTaskCall.call(
                            id: widget.infoTask?.id,
                            observation: _model.observationTextController.text,
                          );
